...
class LandingService with ChangeNotifier {
 ...
 Future<Widget> showUserAvatar(BuildContext context) {
 ...
 Future<Widget> loginSheet(BuildContext context) {
    return showModalBottomSheet(
 ...
 Future<Widget> signInSheet(BuildContext context) {
    return showModalBottomSheet(
        isScrollControlled: true,
        context: context,
        builder: (context) {
 ...
 Future<Widget> warningText(BuildContext context, String warning, double fontsize) {
    return showModalBottomSheet(
      context: context,
      builder: (context) {
        return Container(
 ...
 Future<Widget> forgetPass(BuildContext context) {
    return showModalBottomSheet(
        isScrollControlled: true,
        context: context,
        builder: (context) {
